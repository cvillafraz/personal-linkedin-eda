# Personal LinkedIn EDA guide installation
...
activate personal_linkedin_eda
```
...
To move beyond notebook prototyping, all reusable code should go into the `personal_linkedin_eda/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `personal_linkedin_eda` folder and use the modules inside your notebooks :
...
```python
from personal_linkedin_eda.utils.paths import data_dir
data_dir()
```
